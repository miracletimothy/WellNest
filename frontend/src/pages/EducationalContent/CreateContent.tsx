...
const CreateContent: React.FC = () => {
  ...
  const handleFormSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await axiosInstance.post("/ec/create", formData, {
        headers: {
    ...
    <div id="page-container" className="page-container">
      ...
      <div id="page-content" className="page-content">
        <div className="page-heading-group">
          <h2 id="page-heading" className="page-heading">
            Create content
          </h2>
        </div>

        <section id="large-form">
          <form onSubmit={handleFormSubmit} id="form" className="form">
            ...
            <div id="input-group" className="input-group">
              ...
              <div className="links-input">
                {links.map((link, index) => (
                  <div key={index} className="link-capsule">
                    {link}
            ...
            <div id="input-group" className="input-group">
              <label id="label" className="file-input">
